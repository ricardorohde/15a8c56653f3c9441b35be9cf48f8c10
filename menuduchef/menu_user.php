<script>
    $(function() {
        $("#minha_conta").click(function(){
            espere = <?= $cuidado_apertar_minha_conta ? 1 : 0 ?>;
            if(espere){
                if(confirm("Seu pedido será perdido. Deseja mesmo continuar?")){
...
<div class="div-24-last">
	...
	<!-- A div abaixo destinada para login! -->
        <div id="login"><div id="minha_conta" style="padding-top:15px; color:#F90; cursor:pointer;">Minha conta</div> 
        </div>
        <!-- Termina aqui! -->
        <div id="itens_menu">
