...
if($atendenteSession) {
    $novoped = Pedido::all(array("order" => "quando", "conditions" => array("situacao = ? AND restaurante_id = ?", "novo_pedido", $atendenteSession->restaurante_id)));
    $pedpre = Pedido::all(array("order" => "quando", "conditions" => array("situacao =? AND restaurante_id = ?", "pedido_preparacao", $atendenteSession->restaurante_id)));
    $pedconcan = Pedido::all(array("order" => "quando", "conditions" => array("( situacao=? OR situacao=? ) AND restaurante_id = ?", "pedido_concluido", "cancelado", $atendenteSession->restaurante_id)));
} else {
    exit;
}
?>
...
<script type="text/javascript">
	...
	console.log('Em preparo: ' + preparo.length);
