...
$(document).ready(function(){
  ...
  $(".prod").click(function(){
		...
		for(i=0;i<len;i++){
			alert($("#lista-pedidos div[tem_obs=0]")[i].id);
			if($(teste[0]=='p'+qual){
					achou = 1;
					indice_achado = i;
			}
		...
		alert(qual+" "+nome+" "+preco+" "+qtd+" "+obs+" "+tem_obs+" "+sufixo);
		/*
...
    		$("#lista-pedidos").append("<div id='p"+qual+"_"+sufixo+"' tem_obs='"+tem_obs+"' class='item' style='position:relative;' ><div style='position:relative; margin-left:15px;'> <b>"+nome+"</b> <input type='hidden' class='valor_unitario' value='"+preco+"'></div><div class='qtd' style='position:relative; float:left; margin-left:15px;'> "+qtd+" </div><div> x </div><div class='obs'><br/>"+obs+"</div></div><br/>");
		}
...
<div id="background">
	...
	<div id="centralize">
        ...
        <div id="central">
            ...
            <div id="escolha_pedido" style="background:#CC0000; color:#FFFF00; padding:20px;">
            	MENU<br/><br/>
