 ...
 * 
 * @author  Hédi Carlos Minin - hedicarlos@gmail.com
 */
...
function ClientWindow(id){
	...
	this.updateStatus = function(){
		$(parent.layoutStatus).text('Última atualização: ' +getCurrentTime())		
	}
...
function About(){
	...
	html.push('<ul>');
	html.push('<li>Livre para uso e  modificações :)</li>');
	html.push('<li>Mantenha os créditos :)</li>');
	html.push('<li>Críticas e sugestões serão bem vindas :)</li>');
