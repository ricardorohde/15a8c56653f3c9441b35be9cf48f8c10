...
class Validation {
	...
	public function addMessage($message){
		$this->messages[] = utf8_encode($message);
	}
	
	public function getErrorsAsHtml(){
		return sizeof($this->getErrors()) == 0 ? NULL : utf8_decode('<ul><li>'.implode('</li><li>', $this->getErrors()).'</li></ul>');	
	}
